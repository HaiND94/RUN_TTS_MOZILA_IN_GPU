...
# # TEST for new mode Vietnamese
# # model paths
# TTS_MODEL_1 = "./Tien_Thanh/male/tts_model.pth.tar"
# TTS_CONFIG_1 = "./Tien_Thanh/male/model_config.json"
# VOCODER_MODEL_1 = "./Tien_Thanh/male/vocoder_model.pth.tar"
# VOCODER_CONFIG_1 = "./Tien_Thanh/male/vocoder_config.json"
# time_start_load_1 = time.time()

# # load configs
# TTS_CONFIG_1 = load_config(TTS_CONFIG_1)
# VOCODER_CONFIG_1 = load_config(VOCODER_CONFIG_1)

# # load the audio processor
# ap_1 = AudioProcessor(**TTS_CONFIG_1.audio)         
...
# # load the model
# num_chars_1 = len(phonemes) if TTS_CONFIG_1.use_phonemes else len(symbols)
# model_1 = setup_model(num_chars, len(speakers), TTS_CONFIG_1)

# # load model state
# cp_1 =  torch.load(TTS_MODEL_1, map_location=torch.device(device))

# # load the model
# model_1.load_state_dict(cp_1['model'])
# if use_cuda:
#     model_1.cuda()
# model_1.eval()
...
# # set model stepsize
# if 'r' in cp_1:
#     model_1.decoder.set_r(cp_1['r'])

# # LOAD VOCODER MODEL
# vocoder_model_1 = setup_generator(VOCODER_CONFIG_1)
# vocoder_model_1.load_state_dict(torch.load(VOCODER_MODEL_1, map_location=torch.device(device))["model"])
# vocoder_model_1.remove_weight_norm()
# vocoder_model_1.inference_padding = 0

# ap_vocoder_1 = AudioProcessor(**VOCODER_CONFIG_1['audio'])    
# if use_cuda:
#     vocoder_model_1.cuda()
# vocoder_model_1.eval()
...
thread_1 = Thread(target=tts, args=(model, sentences_1, TTS_CONFIG, use_cuda, ap, vocoder_model))
thread_2 = Thread(target=tts, args=(model, sentences_2, TTS_CONFIG, use_cuda, ap, vocoder_model))
thread_3 = Thread(target=tts, args=(model, sentences_3, TTS_CONFIG, use_cuda, ap, vocoder_model))
# thread_3 = Thread(target=tts, args=(model_1, sentences_3, TTS_CONFIG_1, use_cuda, ap_1, vocoder_model_1))
# thread_4 = Thread(target=tts, args=(model_1, sentences_4, TTS_CONFIG_1, use_cuda, ap_1, vocoder_model_1))
