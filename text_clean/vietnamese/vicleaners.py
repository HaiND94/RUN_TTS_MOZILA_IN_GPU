...
if __name__ == "__main__":
	input = """ Snapdragon 845 có khoảng 5,3 tỷ bóng bán dẫn. Apple A12 Bionic, cũng như Huawei Kirin 980, ước tính có 6,9 tỷ bóng bán dẫn.
	Chiến dịch của Microsoft và Qualcomm để các chip Snapdragon (nhân ARM) chạy trên nền tảng Windows 10 hầu như đều chưa mang đến kết quả cụ thể nào. Ý tưởng về sự kết hợp giữa hiệu suất, năng lượng và khả năng luôn luôn kết nối trên PC chắc chắn là rất hấp dẫn. Tuy nhiên, việc đưa ý tưởng này vào thực tế vẫn còn gặp phải nhiều khó khăn, ngay cả Qualcomm Snapdragon 835 năm ngoái cũng không thể đáp ứng hiệu quả yêu cầu này. Snapdragon 850 mới nhằm khắc phục điều đó (trong trường hợp nó thực sự được trang bị cho các thiết bị thương mại chạy Windows 10).
	Chiều 18/9
	chiều 18/09/2018"""

	ret = cleaners(input).do()
